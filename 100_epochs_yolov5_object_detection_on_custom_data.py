# -*- coding: utf-8 -*-
"""100 epochs-yolov5-object-detection-on-custom-data.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1th6EFgST1FpdSRc3hDOZxnAE7VPAJA7Y
...
# %%time
# %cd /content/yolov5/
# !python train.py --img 416 --batch 8 --epochs 100 --data {dataset.location}/data.yaml --cfg ./models/custom_yolov5s.yaml --weights '' --name yolov5s_results  --cache
